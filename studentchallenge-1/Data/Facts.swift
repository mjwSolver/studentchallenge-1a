...
extension Fact {
    ...
    static let indonesianWasteFact = Fact(
        ...
        statement: """
        Each year, 13-14 million tons of waste is generated by Indonesia.
        
        According to annual data, about 5 million tons (30%) of waste is unprocessed and lies in landfills.
        """,
...
//    )
    ...
    static let koreanWasteFact = Fact(
        ...
        statement:
        """
        South Korean culture is popular in Indonesia and also has a successful Waste-Disposal Policy, inspiring other nations to take action.
        """,
        supportingFact: [
            "South Korea Entertainment and Media is popular in Indonesia",
    ...
    static let encouragementFact = Fact(
        ...
        statement: "Lets live a new lifestyle based on 3R (reduce, reuse, recycle)!",
